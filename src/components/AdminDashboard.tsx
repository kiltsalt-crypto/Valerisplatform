...
export default function AdminDashboard({ onClose }: AdminDashboardProps) {
  ...
  const [tickets, setTickets] = useState<Array<{id: string; status: string; [key: string]: unknown}>>([]);
  const [recentActivity, setRecentActivity] = useState<Array<{id: string; [key: string]: unknown}>>([]);
