...
```bash
# ONE-TIME: Set up automated deployment (10 minutes)
./setup-automation.sh

# DAILY: Deploy changes automatically (30 seconds)
./deploy.sh
# OR manually:
...
**Run once, deploy forever:**

```bash
./setup-automation.sh
```

This sets up automatic deployment so every time you push to GitHub, your site auto-deploys to Netlify.
...
See `AUTOMATED_DEPLOYMENT_SETUP.md` for full details.
